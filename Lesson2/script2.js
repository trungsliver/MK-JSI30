// Ôn tập Javascript (phiên bản ES6)
    // Phạm vi biến (Variable Scope)
        // Biến toàn cục (Global variable): Được khai báo ngoài, truy cập được từ mọi nơi.
let subject = "JavaScript";     // Biến toàn cục
var level = 'Intensive';        // Biến toàn cục
        // Biến cục bộ (Local variable): Được khai báo trong hàm, chỉ truy cập được trong hàm đó.
function showInfo() {
...
const addArrow = (a, b) => a + b;
        ...
        // Hàm mũi tên với nhiều dòng lệnh
...
let str1 = `Học ${subject} tại MindX ${level}`;

    // Array/List nâng cao
        // map: duyệt và biến đổi phần tử
const students1 = ['Tú', 'Ngọc', 'Dũng', 'Huy', 'Quân'];
const students_updated = students1.map(name => `${name}-JSI30`);  
console.log(students_updated);  
